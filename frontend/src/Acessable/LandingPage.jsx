...
const Landingpage = () => {
  ...
  return (
    <>
    <div className=' w-screen  h-screen   md:h-screen   grid  grid-rows-2 gap-5 '>
      <div className='grid w-full h-fit justify-items-center  '>
        ...
        <ul className='  grid-flow-col gap-2  lg:grid-cols-5 lg:text-lg font-letter lg:text-gray-500  md:gap-0 w-full grid justify-items-center text-xs '>
                <li className='hover: hover:text-black cursor-pointer  border-black'>HOME</li>
                <li className='hover: hover:text-black cursor-pointer  border-black'>CONTACT</li>
                <li className='hover: hover:text-black cursor-pointer  border-black'>ABOUT US</li>
                <li className='hover: hover:text-black cursor-pointer  border-black'>FREE SERVICES</li>
                <li className='hover: hover:text-black cursor-pointer  border-black  '>SIGN IN</li>
            </ul> 
        
        </div>
<div className='grid lg:grid-cols-2 gap-5 mt-5'>
        <div className='font-bold9  text-5xl lg:text-7xl row-span-1'>Accelerate  your <span className='text-blue-700'>business</span>   with us </div> 
   
        <div className='w-full h-full row-span-2 ' >
            <img src='./conference.png'></img>
        </div>
        <div className='font-letter text-lg text-gray-500 row-span-1'>
        we offer a range of business solutions for micro,small and medium enterprises for very less to free of cost .
        To make business easy and affordable services and products like Accounting Software  and Invoice Software integrated Eway bill and e invoiceing  ,Online Store , Tax filling are provided for free
