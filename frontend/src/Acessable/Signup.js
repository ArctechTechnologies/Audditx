    ...
    <>
      <div className='w-full h-full  grid justify-items-center items-center '>
        <div className='shadow-lg border w-11/12 '>
          <h5 className='text-5xl font-bold9 text-center w-full '>AUDDITX</h5>
            ...
            <div className='w-full h-full  grid grid-row-5 gap-3'>
              <div className='justify-items-center items-center'>
                ...
                <div className='w-full grid  grid-cols-2 gap-3 mt-3 '>
                  ...
                  <div className=''>
                    <label for="phone" className="block mb-2 text-sm font-medium text-gray-900 ">GSTIN <span className='text-gray-600'>(if applicable)</span></label>
                  ...
                  <div className='grid  items-center  grid-flow-row w-full'>
                ...
                <div className='w-full   gap-3 mt-3 '>
                  <div className='  items-center gap-3'>
                    ...
                    <div className='flex flex-col	 ' >
                      ...
                      <input type="name" id="Username" className="w-1/2 m-auto bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5 " placeholder="Username" value={userDetails.Username}
                        onChange={handleChange} required />
                      <div>
                        <label for="phone" className="block mb-2 text-sm font-medium text-gray-900  ">Password<span className='text-gray-600'></span></label>
                        <input type="name" id="Password" className="w-1/2 m-auto bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5 " placeholder="Password"
                          onChange={handleChange} required />
                      </div>
                    </div>
